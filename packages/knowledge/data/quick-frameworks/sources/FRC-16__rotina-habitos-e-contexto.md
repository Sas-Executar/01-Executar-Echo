# FRC-16 Rotina hábitos e contexto
...
**Premissa 1 — Problema:** Ausência de pistas estáveis aumenta preparação e decisão recorrente  
...
**Conclusão:** Contexto estável reduz decisões repetidas de início. — síntese a partir de ISO  
**Ilustração de topo:** Cena editorial que contrasta demanda invisível com controle externalizado.  
**Relacionados:** FRC-15, FRC-17.
