# FRC-17 Preparação antes da execução
...
**Premissa 1 — Problema:** Pré-condições não verificadas transformam execução em busca e espera  
...
**Conclusão:** Preparar o caminho evita decidir durante cada passo. — síntese a partir de W3C COGA  
**Ilustração de topo:** Cena editorial que contrasta demanda invisível com controle externalizado.  
**Relacionados:** FRC-16, FRC-18.
