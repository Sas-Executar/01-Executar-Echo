...
**Premissa 1 — Problema:** Hierarquia ausente obriga o leitor a reconstruir a estrutura  
...
**Conclusão:** A forma da informação também consome capacidade. — síntese a partir de Rosenholtz et al.  
**Ilustração de topo:** Cena editorial que contrasta demanda invisível com controle externalizado.  
**Relacionados:** FRC-03, FRC-05.
