...
**Etimologia.** Decisão vem do latim decidere, cortar fora alternativas. Fadiga vem de fatigare, cansar. O termo descreve piora associada a sucessivas decisões, mas seus efeitos dependem de contexto e evidência.

## 2. Contexto

Ao longo do dia, uma pessoa decide prioridades, canais, formatos e exceções. No fim, escolhas simples passam a ser adiadas ou automáticas. O fator não caracteriza risco sozinho: precisa ser analisado com objetivo, contexto, vulnerabilidade, exposição e impacto.

## 3. 5W2H

| Variável | Síntese |
|---|---|
| O que? | Investigar fadiga decisória na execução real. |
...
Pignatiello et al. é usado como referência central deste framework porque a fonte associada documenta princípios ou achados diretamente aplicáveis ao fator. A centralidade vale para este recorte; não significa consenso exclusivo sobre todo o tema.

**Autor curto:** Pignatiello et al.

## 5. Problema existente

**Definição.** Muitas decisões recorrentes consomem tempo e controle executivo.  
...
**Identificação.** Padronizar escolhas repetitivas e reservar decisão para exceções reais.  
...
**Premissa 1 — Problema:** Muitas decisões recorrentes consomem tempo e controle executivo  
...
**Conclusão:** Decisões repetidas podem degradar a qualidade da escolha. — síntese a partir de Pignatiello et al.  
**Ilustração de topo:** Cena editorial que contrasta demanda invisível com controle externalizado.  
**Relacionados:** FRC-12, FRC-14.
