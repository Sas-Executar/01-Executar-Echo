# FRC-14 Ambiente físico e ergonomia
...
**Premissa 1 — Problema:** Condições físicas e organizacionais acrescentam demanda evitável  
...
**Conclusão:** O ambiente deve se ajustar ao trabalho humano. — síntese a partir de ISO  
**Ilustração de topo:** Cena editorial que contrasta demanda invisível com controle externalizado.  
**Relacionados:** FRC-13, FRC-15.
