...
**Premissa 1 — Problema:** Tarefa vaga não define ação observável nem estado de pronto  
...
**Conclusão:** Tarefa ambígua adia a decisão para a execução. — síntese a partir de W3C COGA  
**Ilustração de topo:** Cena editorial que contrasta demanda invisível com controle externalizado.  
**Relacionados:** FRC-06, FRC-08.
