...
**Premissa 1 — Problema:** Estados distribuídos, duplicação e notificações fragmentam a continuidade  
...
**Conclusão:** Digitalizar não garante reduzir trabalho cognitivo. — síntese a partir de W3C WAI  
**Ilustração de topo:** Cena editorial que contrasta demanda invisível com controle externalizado.  
**Relacionados:** FRC-14, FRC-16.
