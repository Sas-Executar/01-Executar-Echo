...
**Premissa 1 — Problema:** Volume simultâneo aumenta busca, comparação e manutenção mental  
...
**Conclusão:** Mais informação disponível não significa mais informação utilizável. — síntese a partir de W3C WAI  
**Ilustração de topo:** Cena editorial que contrasta demanda invisível com controle externalizado.  
**Relacionados:** FRC-02, FRC-04.
