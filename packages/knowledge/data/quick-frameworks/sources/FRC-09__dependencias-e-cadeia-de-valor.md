...
**Premissa 1 — Problema:** Dependências implícitas geram início prematuro, espera e retrabalho  
...
**Conclusão:** Lista completa pode esconder a ordem real do trabalho. — síntese a partir de ISO  
**Ilustração de topo:** Cena editorial que contrasta demanda invisível com controle externalizado.  
**Relacionados:** FRC-08, FRC-10.
