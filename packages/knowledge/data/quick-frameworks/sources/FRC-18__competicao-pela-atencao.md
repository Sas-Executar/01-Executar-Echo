# FRC-18 Competição pela atenção
...
**Premissa 1 — Problema:** Sinais simultâneos tornam prioridade e relevância menos distinguíveis  
...
**Conclusão:** Quando tudo chama atenção nada orienta a ação. — síntese a partir de W3C WAI  
**Ilustração de topo:** Cena editorial que contrasta demanda invisível com controle externalizado.  
**Relacionados:** FRC-17, FRC-19.
