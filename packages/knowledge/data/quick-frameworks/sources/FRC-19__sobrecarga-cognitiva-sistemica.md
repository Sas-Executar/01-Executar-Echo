# FRC-19 Sobrecarga cognitiva sistêmica
...
**Premissa 1 — Problema:** Fricções distribuídas se acumulam e escondem a causa operacional  
...
**Conclusão:** Pequenas fricções podem formar um problema do sistema. — síntese a partir de ISO  
**Ilustração de topo:** Cena editorial que contrasta demanda invisível com controle externalizado.  
**Relacionados:** FRC-18, FRC-20.
