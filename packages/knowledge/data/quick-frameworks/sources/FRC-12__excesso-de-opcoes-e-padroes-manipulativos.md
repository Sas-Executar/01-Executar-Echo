# FRC-12 Excesso de opções e padrões manipulativos
...
**Premissa 1 — Problema:** Quantidade, assimetria e manipulação tornam a escolha mais trabalhosa  
...
**Conclusão:** Escolha útil exige opções compreensíveis e honestas. — síntese a partir de W3C WAI  
**Ilustração de topo:** Cena editorial que contrasta demanda invisível com controle externalizado.  
**Relacionados:** FRC-11, FRC-13.
