# FRC-02 Perfil cognitivo do executor
...
**Premissa 1 — Problema:** Desenho uniforme que ignora variação funcional e contexto  
...
**Conclusão:** O sistema deve apoiar diferenças sem rotular pessoas. — síntese a partir de W3C COGA  
**Ilustração de topo:** Cena editorial que contrasta demanda invisível com controle externalizado.  
**Relacionados:** FRC-01, FRC-03.
